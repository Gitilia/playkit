...
| `PLAYKIT_PUSHGATEWAY_URL` | if metrics | e.g. `http://10.0.10.x:9091` |
...
**Mailpit** — it's our homelab SMTP trap (`10.0.10.x`, no external
...
points at that trap (Mailpit `10.0.10.x:1025` in DEV, or Mailtrap's
